    ...
    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener()
    {
      public void onClick(DialogInterface dialog, int which)
      {
        ...
        else
        {
          ...
          progress.show();
          SmartCommands.execute(new DialogGuardedCommand(getActivity(), OrderConfirmDialogFragment.this, "An error occured when add user" + emailValue, R.string.add_user_error_message, progress)
          {
            @Override
