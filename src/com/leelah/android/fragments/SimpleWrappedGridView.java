 ...
 * @since 2008.11.14
 */
public class SimpleWrappedGridView<BusinessObjectClass, ViewClass extends View>
    extends WrappedListView<BusinessObjectClass, GridView, ViewClass>
{
  ...
  public SimpleWrappedGridView(Activity activity, ForList<BusinessObjectClass, ViewClass> forListProvider)
  {
    super(activity);
  ...
  @Override
  protected GridView computeListView(Activity activity)
  {
  ...
  protected final void setAdapter()
  {
    listView.setOnItemLongClickListener(new OnItemLongClickListener()
    {
      public boolean onItemLongClick(AdapterView<?> adapter, View view, int position, long rowId)
      {
        ...
        final int actualPosition = position;// - (listView instanceof ListView ? ((ListView) listView).getHeaderViewsCount() : 0);
  ...
  {
    listView.setSelection(position);// + (listView instanceof ListView ? ((ListView) listView).getHeaderViewsCount() : 0));
  }
