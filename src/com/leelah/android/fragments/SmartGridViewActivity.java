 ...
 * @since 2011.12.14
 */
public abstract class SmartGridViewActivity<AggregateClass, ListViewClass extends ViewGroup>
    ...
    implements DetailsProvider.ForList<SmartAdapters.BusinessViewWrapper<?>, View>, WrappedListView.OnEventObjectListener<SmartAdapters.BusinessViewWrapper<?>>
{
  ...
  {
    return (WrappedListView<SmartAdapters.BusinessViewWrapper<?>, ListViewClass, View>) new SimpleWrappedGridView<SmartAdapters.BusinessViewWrapper<?>, View>(getActivity(), this)
    {
      @Override
      ...
      {
        return SmartGridViewActivity.this.getContextualMenuCommands(businessObject);
      }
    };
  }
