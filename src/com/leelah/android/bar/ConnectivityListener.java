    ...
    implements AppPublics.BroadcastListener
{
  ...
  public void onReceive(Intent intent)
  {
    ...
    if (previousConnectivity != hasConnectivity)
    {
      ...
      context.sendBroadcast(new Intent(ConnectivityListener.CONNECTIVITY_CHANGED_ACTION).putExtra(ConnectivityListener.EXTRA_HAS_CONNECTIVITY, hasConnectivity));
